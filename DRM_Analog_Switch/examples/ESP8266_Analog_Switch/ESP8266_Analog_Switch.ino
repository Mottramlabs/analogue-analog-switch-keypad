/*
      Analog switch demo - ESP8266 version
      Input from switch panel is on A0 (Low output from switch panel, VCC to switch is 3.3V
      Using low output from switch panel is 0-1V
      13th February 2020
*/
